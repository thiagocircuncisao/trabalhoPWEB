# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-13 16:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Baixas',
            fields=[
                ('baixasId', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Lancamentos',
            fields=[
                ('lancamentosId', models.AutoField(primary_key=True, serialize=False)),
                ('tipoLancamento', models.CharField(max_length=1)),
                ('numeroDocumento', models.CharField(max_length=20)),
                ('dataVencimento', models.DateField()),
                ('dataEmissao', models.DateField()),
                ...
                ('valorTitulo', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='BRL', max_digits=100)),
                ('empresaId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.Empresa')),
                ('pessoaId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.Pessoa')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Tesouraria',
            fields=[
                ('tesourariaId', models.AutoField(primary_key=True, serialize=False)),
                ('empresaId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.Empresa')),
                ('formasPagamentoId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.FormaPagamento')),
                ('pessoaId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.Pessoa')),
                ('planoContasId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.PlanoContas')),
            ],
            options={
