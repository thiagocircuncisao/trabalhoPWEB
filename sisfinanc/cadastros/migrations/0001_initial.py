    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bairro', models.CharField(max_length=50)),
                ('cep', models.CharField(max_length=10)),
                ('municipioID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.Muncipio')),
            ],
            options={
                'verbose_name': 'Pessoa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contaBancariaId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.ContaBancaria')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='empresa',
            name='municipioID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastros.Muncipio', verbose_name='Município'),
        ),
        migrations.AddField(
            model_name='empresa',
            name='titularId',
